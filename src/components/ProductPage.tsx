    ...
    <div className="product">
      ...
      <Dialog open={openDialog}>
        <DialogContent className="p-4 text-center">
          ...
          <p className={dialogType === 'report' ? 'hidden' : ''}>
            고객님께서 작성하신 후기가 삭제됩니다.
            <br />
            정말 삭제 하시겠습니까?
          </p>
        </DialogContent>
        <DialogActions className="flex justify-center pb-4">
          <div className={dialogType === 'report' ? 'hidden' : ''}>
            <button
              type="button"
              className="rounded bg-blue-400 text-white text-sm px-4 py-1"
            ...
            <button
              type="button"
              className="ml-2 rounded bg-blue-600 text-white text-sm px-4 py-1"
              onClick={handleCloseDialog}
            >
              확인
            </button>
          ...
          <div className={dialogType === 'delete' ? 'hidden' : ''}>
            <button
              type="button"
              className="rounded bg-blue-600 text-white text-sm px-4 py-1"
              onClick={handleCloseDialog}
            >
              확인
            </button>
          ...
          <div className="sort-comment flex justify-between mt-8">
            ...
            <div aria-label="right">
              <FormControl variant="outlined">
                ...
                >
                  <MenuItem className="text-sm" value="recent">
                    최신순
                  </MenuItem>
                  <MenuItem className="text-sm" value="high">
                    평점&#8593;
                  </MenuItem>
                  <MenuItem className="text-sm" value="low">
                    평점&#8595;
                  </MenuItem>
                </Select>
              </FormControl>
          ...
          <ul className="list-comment">
            <li className="list-comment__item">
              <div className="flex justify-between mb-2">
                ...
                <div aria-label="right" className="flex items-center">
                  ...
                  <button
                    type="button"
                    aria-label="신고"
                    className="btn-report flex items-center ml-1 rounded bg-blue-600 text-white p-1 xl:translate-x-10"
              ...
              <p className="break-words">
                ㅋㅋㅋㅋ 이거 대박이네요 ㅋㅋㅋㅋ 이거 대박이네요 ㅋㅋㅋㅋ 이거 대박이네요 ㅋㅋㅋㅋ 이거 대박이네요
                ㅋㅋㅋㅋ 이거 대박이네요 ㅋㅋㅋㅋ 이거 대박이네요{' '}
              </p>
            </li>
            <li className="list-comment__item">
              <div className="flex justify-between mb-2">
                ...
                <div aria-label="right" className="flex items-center">
                  ...
                  <button
                    type="button"
                    aria-label="수정"
                    className="flex items-center ml-2 rounded bg-blue-600 text-white p-1"
                  >
              ...
              <p className="break-words">
                오오! 바로 공유들어갑니다 ㅎㅎ 오오! 바로 공유들어갑니다 ㅎㅎ 오오! 바로 공유들어갑니다 ㅎㅎ 오오! 바로
                공유들어갑니다 ㅎㅎ 오오! 바로 공유들어갑니다 ㅎㅎ 오오! 바로 공유들어갑니다 ㅎㅎ 오오! 바로
                공유들어갑니다 ㅎㅎ 오오! 바로 공유들어갑니다 ㅎㅎ
              </p>
            </li>
            <li className="list-comment__item">
              <div className="flex justify-between mb-2">
              ...
              <p className="break-words">
                장난하나?? 이게 뭐라고 다들 이렇게 난리법석?? 장난하나?? 이게 뭐라고 다들 이렇게 난리법석?? 장난하나??
                이게 뭐라고 다들 이렇게 난리법석??{' '}
              </p>
            </li>
            <li className="list-comment__item">
            ...
            <li className="list-comment__item">
              ...
              <p className="break-words">
                saasdfkljadjkls(#*$& asdfjklaldfjkssafjdfjklalfjdslfkjasdlfkjsdflkj
                adfklsjasdfjklsadfkljsadfkljsadfkljsdafkljasdljaslsflfasfjsdklfjasd
              </p>
            </li>
            <li className="list-comment__item">
              <div className="flex justify-between mb-2">
        ...
        <DialogContent className="" dividers>
          ...
          <div className="mt-3 mb-4">
            <button
              type="button"
              id="btnCopyCode"
              className="btn-copy-url text-white text-xs lg:text-base bg-blue-600"
